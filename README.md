...
in video surveillance it could be a significant issue to forget
detecting a human in uncommon pose. We propose a
...
for many applications. Moreover, a simple data augmentation
is not efficient to generalize our training. We need
...
or K-means to compute a pseudo label. A summary of theoretical
results is described in a first section to illustrate
...
sequence of rotations of original view, to process a detection
in a compensated view. In second step, we will learn
this distortion created by the various views and construct
an approach to distill original knowledge to a more generalized
training.
